          ...
          >
            ...
            >
              ...
              <div className="space-y-2.5">
                ...
                <a
                  href="https://t.me/piketplace"
                  onClick={(event) => {
                    event.preventDefault()
                    openSocial('https://t.me/piketplace')
                  }}
                  className="flex w-full items-center gap-3 rounded-xl bg-blue-50 px-4 py-3 text-sm font-bold text-blue-500 transition hover:bg-blue-100"
                >

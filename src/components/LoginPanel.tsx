  ...
  return (
    <>
        ...
        <div className="fixed inset-0 z-30 flex flex-col items-center justify-center gap-4 bg-white/40 px-6 text-center backdrop-blur-[4px]">
          ...
          <div>
            <h2 className="text-lg font-bold text-primary-dark">
              {t('login_title', { defaultValue: 'Sign in to continue' })}
            </h2>
      ...
      {langOpen &&
        createPortal(
          <div
            className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 overscroll-contain"
            onClick={() => setLangOpen(false)}
          >
            <div
              className="w-full max-w-[430px] rounded-t-3xl bg-white p-5 py-2 overscroll-contain"
